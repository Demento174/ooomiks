...
trait YFYM_T_Common_Skips {
	public function get_skips() {
		...
		if ($product->get_status() !== 'publish') {
			$this->add_skip_reason(array('reason' => __('The product status/visibility is', 'yfym').' "'.$product->get_status().'"', 'post_id' => $product->get_id(), 'file' => 'trait-yfym-t-common-skips.php', 'line' => __LINE__)); return '';
		}
