...
trait YFYM_T_Common_Get_CatId {
	public function get_catid($catid = null) {
		...
		if ($catid == '') {
			$this->add_skip_reason(array('reason' => __('The product has no categories', 'yfym'), 'post_id' => $product->get_id(), 'file' => 'trait-yfym-t-common-get-catid.php', 'line' => __LINE__)); return '';
		}
