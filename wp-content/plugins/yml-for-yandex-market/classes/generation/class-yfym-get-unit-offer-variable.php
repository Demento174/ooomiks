...
class YFYM_Get_Unit_Offer_Variable extends YFYM_Get_Unit_Offer {
	...
	public function generation_product_xml($result_xml = '') {
		...
		$result_xml = apply_filters('y4ym_f_append_variable_offer', $result_xml, array('product' => $this->product, 'offer' => $this->offer, 'feed_category_id' => $this->get_feed_category_id()), $this->feed_id);
