<?php
namespace Classes\SimpleAJAX;
use Classes\Form\FormController;
use Classes\Import\Suppliers\Matrix;
use Classes\PostsAndTax\PostProduct;
use Classes\WC\SearchForm;
...
class SimpleAJAX {
    ...
    {
        set_time_limit(0);
        $mat = new \Classes\Import\Suppliers\Matrix($_POST['url'],$_POST);
    ...
    {
        set_time_limit(0);
        $m = new \Classes\Import\Suppliers\Matrix();
        $m->handler_products();
        wp_die();
    }
