...
use \Classes\Translite\TransliteController;
use \Classes\Widgets\Controllers\AcfRegisterBlock;
use Classes\Widgets\Widgets\WidgetAbstract;
...
//                if(!key_exists('namespace',$options))Errors::init(Errors::ERROR['template_namespace']);
                ...
                $name = key_exists('name',$options)?
                    $options['name']:
                    TransliteController::convertor($options['title']);
                $options['name'] = $name;
