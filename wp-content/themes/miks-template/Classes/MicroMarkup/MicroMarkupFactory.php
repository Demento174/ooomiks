...
namespace Classes\MicroMarkup;
use Classes\MicroMarkup\Types\Breadcrumbs;
use Classes\MicroMarkup\Types\MicroMarkupAbstract;
use Classes\MicroMarkup\Types\Organization;
...
//            get_category_parents(get_the_category($queryObject->ID)[0]->term_id)
            ...
            if(array_search(3, $parents) !== false)
            {
                ...
                $result = new \Classes\MicroMarkup\Types\MicroMarkupMixinTypes([Breadcrumbs::index(),\Classes\MicroMarkup\Types\Product\Concrete::index($queryObject)]);
            }else
                {
                    switch ($queryObject->ID)
                    {
                        ...
                        case 177:
                        case 105:
                            $result = new \Classes\MicroMarkup\Types\MicroMarkupMixinTypes([Breadcrumbs::index(),Organization::index()]);
                            break;
                        default:
