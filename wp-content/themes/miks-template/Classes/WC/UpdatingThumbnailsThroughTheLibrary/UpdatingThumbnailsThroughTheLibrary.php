<?php
namespace Classes\WC\UpdatingThumbnailsThroughTheLibrary;

use \Classes\PostsAndTax\PostAttachment as PostAttachment;
...
class UpdatingThumbnailsThroughTheLibrary extends Settings
{
    ...
    private function set_product($article)
    {
        ...
        $this->product = \Classes\PostsAndTax\PostProduct::get_product_by_article($article);
    }
