...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p class="woocommerce-form-row form-row">
		<input class="woocommerce-Input woocommerce-Input--text input-text reset_password"
			placeholder="<?php esc_html_e( 'Username or email', 'woocommerce' ); ?>" type="text" name="user_login"
